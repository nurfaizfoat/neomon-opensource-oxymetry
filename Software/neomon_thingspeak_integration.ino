...
char ssid[] = "test";
char wifiPassword[] = "test1234";
//ThingSpeak Channel Settings 
unsigned long myChannelNumber = 395114;
const char * myWriteAPIKey = "QSDL7ULTWM2EQ6D8";
...
void   thingspeak_integration()
{
  ...
  ThingSpeak.setField(1,pox.getHeartRate());
  ThingSpeak.setField(2,pox.getSpO2());
  ThingSpeak.setField(3,temp.cel());
}
